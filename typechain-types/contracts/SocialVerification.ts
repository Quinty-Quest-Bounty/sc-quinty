...
export interface SocialVerificationInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addVerifier"
  ...
  encodeFunctionData(
    functionFragment: "submitSocialProof",
  ...
  encodeFunctionData(
    functionFragment: "verifySocialProof",
...
export interface SocialVerification extends BaseContract {
  connect(runner?: ContractRunner | null): SocialVerification;
  ...
  submitSocialProof: TypedContractMethod<
  ...
  verifySocialProof: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "submitSocialProof"
  ): TypedContractMethod<
    [proof: BytesLike, socialHandle: string, institutionName: string],
    [void],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "verifySocialProof"
  ): TypedContractMethod<
    [proof: BytesLike, publicInputs: BytesLike],
    [boolean],
    "view"
